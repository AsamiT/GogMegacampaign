...
cp -rv Gogmod ~/.local/share/Paradox\ Interactive/Europa\ Universalis\ IV/mod/Gogmod
cp -v Gogmod.mod ~/.local/share/Paradox\ Interactive/Europa\ Universalis\ IV/mod/Gogmod.mod
echo
